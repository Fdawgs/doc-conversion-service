...
-   build(deps-dev): bump eslint from 7.14.0 to 7.16.0 ([1f657ed](https://github.com/Fdawgs/doc-conversion-service/commit/1f657ed))
-   build(deps-dev): bump eslint-config-prettier from 6.15.0 to 7.1.0 ([029f6ef](https://github.com/Fdawgs/doc-conversion-service/commit/029f6ef))
-   build(deps-dev): bump eslint-plugin-jsdoc from 30.7.8 to 30.7.9 ([e4c4d6f](https://github.com/Fdawgs/doc-conversion-service/commit/e4c4d6f))
-   build(deps): bump file-type from 16.0.1 to 16.1.0 ([9ba23e9](https://github.com/Fdawgs/doc-conversion-service/commit/9ba23e9))
-   build(deps): bump ini from 1.3.5 to 1.3.8 ([75d8168](https://github.com/Fdawgs/doc-conversion-service/commit/75d8168))
-   build(deps): bump node-poppler from 2.0.1 to 2.1.1 ([171f51d](https://github.com/Fdawgs/doc-conversion-service/commit/171f51d))
-   build(deps): bump node-unrtf from 1.0.3 to 1.0.4 ([93884d3](https://github.com/Fdawgs/doc-conversion-service/commit/93884d3))
-   build(deps): bump pino from 6.7.0 to 6.8.0 ([01dae41](https://github.com/Fdawgs/doc-conversion-service/commit/01dae41))
-   build(deps): bump sanitize-middleware from 4.0.0 to 4.0.1 ([9303dad](https://github.com/Fdawgs/doc-conversion-service/commit/9303dad))
-   build(deps): bump uuid from 8.3.1 to 8.3.2 ([95e9060](https://github.com/Fdawgs/doc-conversion-service/commit/95e9060))
-   fix: adhere to `arrow-body-style` eslint rule ([74cb813](https://github.com/Fdawgs/doc-conversion-service/commit/74cb813))
-   ci: add aggregate coverage calculations ([28198fd](https://github.com/Fdawgs/doc-conversion-service/commit/28198fd))
-   ci: add coveralls github action ([d199664](https://github.com/Fdawgs/doc-conversion-service/commit/d199664))
-   ci: add linting job; expand scope of jobs ([39cf2b4](https://github.com/Fdawgs/doc-conversion-service/commit/39cf2b4))
-   ci: automatically merge dependabot pull requests on pass build stage ([7472c1d](https://github.com/Fdawgs/doc-conversion-service/commit/7472c1d))
-   ci: clean up config ([4d94b83](https://github.com/Fdawgs/doc-conversion-service/commit/4d94b83))
-   ci: correct test script ([a16254f](https://github.com/Fdawgs/doc-conversion-service/commit/a16254f))
-   ci: replace travis-ci with github actions ([7faee93](https://github.com/Fdawgs/doc-conversion-service/commit/7faee93))
-   ci: require lint job on automerge ([f2f5495](https://github.com/Fdawgs/doc-conversion-service/commit/f2f5495))
-   chore: add security.md ([0dc9977](https://github.com/Fdawgs/doc-conversion-service/commit/0dc9977))
-   chore: add stale confg ([44584a5](https://github.com/Fdawgs/doc-conversion-service/commit/44584a5))
-   chore(scripts): rename test scripts ([47091d3](https://github.com/Fdawgs/doc-conversion-service/commit/47091d3))
-   docs(readme): fix ci badge ([92cbda5](https://github.com/Fdawgs/doc-conversion-service/commit/92cbda5))
-   docs(readme): remove abbreviation ([9506314](https://github.com/Fdawgs/doc-conversion-service/commit/9506314))
-   docs(readme): update ci badge ([3d5a303](https://github.com/Fdawgs/doc-conversion-service/commit/3d5a303))
-   docs(readme): update deployment scripts ([a3b9423](https://github.com/Fdawgs/doc-conversion-service/commit/a3b9423))
-   docs(readme): update run script ([8dcccb3](https://github.com/Fdawgs/doc-conversion-service/commit/8dcccb3))
-   feat(config): allow log rotation to be customised; tidy env template ([36741b4](https://github.com/Fdawgs/doc-conversion-service/commit/36741b4))
-   style: fix white space and naming conventions ([3602fe6](https://github.com/Fdawgs/doc-conversion-service/commit/3602fe6))
-   style: format codeql.yml ([8a6a352](https://github.com/Fdawgs/doc-conversion-service/commit/8a6a352))
-   style: tidy whitespace of ci.yml ([cbda562](https://github.com/Fdawgs/doc-conversion-service/commit/cbda562))
...
-   build(deps-dev): bump dev dependencies ([d2acc21](https://github.com/Fdawgs/doc-conversion-service/commit/d2acc21))
-   build(deps): bump node-poppler from 1.8.4 to 1.8.5 ([e64835a](https://github.com/Fdawgs/doc-conversion-service/commit/e64835a))
-   build(deps): bump node-unrtf from 0.0.2 to 1.0.0 ([b87981a](https://github.com/Fdawgs/doc-conversion-service/commit/b87981a))
-   build(deps): bump node-unrtf from 1.0.0 to 1.0.1 ([25e5e90](https://github.com/Fdawgs/doc-conversion-service/commit/25e5e90))
-   build(deps): bump sanitize-middleware from 2.0.19 to 3.0.0 ([0354985](https://github.com/Fdawgs/doc-conversion-service/commit/0354985))
-   build(deps): bump uuid from 8.3.0 to 8.3.1 ([81e1581](https://github.com/Fdawgs/doc-conversion-service/commit/81e1581))
-   build(deps): move is-html to dev dependencies ([7f9ac47](https://github.com/Fdawgs/doc-conversion-service/commit/7f9ac47))
-   build(docker): restrict mapped ports to localhost ([41911b2](https://github.com/Fdawgs/doc-conversion-service/commit/41911b2))
-   build(docker): update system and dependencies ([889c1ba](https://github.com/Fdawgs/doc-conversion-service/commit/889c1ba))
-   ci(travis): add unrtf to linux test stage ([5f7d40f](https://github.com/Fdawgs/doc-conversion-service/commit/5f7d40f))
-   ci(travis): fix indents ([4582339](https://github.com/Fdawgs/doc-conversion-service/commit/4582339))
-   ci(travis): move macos test to own stage ([7bc8415](https://github.com/Fdawgs/doc-conversion-service/commit/7bc8415))
-   ci(travis): remove poppler brew install; already in travis ([0de8b05](https://github.com/Fdawgs/doc-conversion-service/commit/0de8b05))
-   ci(travis): update osx image ([5519326](https://github.com/Fdawgs/doc-conversion-service/commit/5519326))
-   style: tidy whitespace ([8290e32](https://github.com/Fdawgs/doc-conversion-service/commit/8290e32))
-   test(middleware): add locals object to mock response ([e454cc8](https://github.com/Fdawgs/doc-conversion-service/commit/e454cc8))
-   test(middleware): remove platform specific tests ([8929846](https://github.com/Fdawgs/doc-conversion-service/commit/8929846))
-   fix(middleware): catch empty bodies before pdftotxt parses them ([ce2275e](https://github.com/Fdawgs/doc-conversion-service/commit/ce2275e))
-   fix(middleware): catch empty bodies before unrtf parses them ([24d9319](https://github.com/Fdawgs/doc-conversion-service/commit/24d9319))
-   fix(middleware): remove unnecessary regex ([6f66710](https://github.com/Fdawgs/doc-conversion-service/commit/6f66710))
-   docs(contributing): remove reference to replaced jest script ([2ab7f14](https://github.com/Fdawgs/doc-conversion-service/commit/2ab7f14))
-   docs(contributing): spelling and grammar fixes ([ffebe80](https://github.com/Fdawgs/doc-conversion-service/commit/ffebe80))
-   docs(middleware): remove reference to poppler ([5577e32](https://github.com/Fdawgs/doc-conversion-service/commit/5577e32))
-   refactor(middleware): replace rtf.js dependency with node-unrtf ([5f6b5c4](https://github.com/Fdawgs/doc-conversion-service/commit/5f6b5c4))
-   refactor(middleware): use res.locals to results ([bb59253](https://github.com/Fdawgs/doc-conversion-service/commit/bb59253))
-   refactor(routes): return res.locals.body instead of req.body ([ad376e1](https://github.com/Fdawgs/doc-conversion-service/commit/ad376e1))
-   tests(middleware): extend test pass conditions ([cf6d681](https://github.com/Fdawgs/doc-conversion-service/commit/cf6d681))
-   tests(middleware): remove redundant body declaration ([c488405](https://github.com/Fdawgs/doc-conversion-service/commit/c488405))
-   tests(middleware): use `httpmocks.createrequest()` over raw object ([06baeb6](https://github.com/Fdawgs/doc-conversion-service/commit/06baeb6))
-   feat(middleware): add file type validation of uploads ([43d3ec6](https://github.com/Fdawgs/doc-conversion-service/commit/43d3ec6))
