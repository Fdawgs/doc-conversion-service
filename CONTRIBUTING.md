...
As mentioned in the prerequisites section of [README.md](https://github.com/Fdawgs/doc-conversion-service/blob/master/README.md#prerequisites) this repository requires that you have [Node.js](https://nodejs.org) installed.
...
-   `npm run nodemon` - Starts a development server with live reload, available on `localhost:3000` unless you specify your own port
...
3. Run `npm run prettier` to run the Prettier code formatter over the code
...
Please file your issues [here](https://github.com/Fdawgs/doc-conversion-service/issues) and try to provide as much information in the template as possible/relevant.
